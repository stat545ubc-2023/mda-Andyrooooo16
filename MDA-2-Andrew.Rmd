...
*1. What is the relationship between the age of the tree and the neighborhood it was planted in??* (This question use to be "What is the relationship between density of trees in a neighbourhood and the age of the trees planted?", however, upon further consideration, I did not believe there would be tangible correlation between density of tree clusters and age.Instead I wish to explore how many trees there are in a neighborhood in relationship to age of trees planted to explore planting trends.)
...
*4. What is the relationship between species diversity and longitude/latitude? Is there a specific species that dominates a certain area of vancouver or is the distribution fairly equal?* 
<!----------------------------------------------------------------------------->
...
*What is the relationship between the age of the tree and the neighborhood it was planted in??*
...
# Create a heatmap
heatmap_plot <- ggplot(vancouver_trees_age, aes(x = neighbourhood_name, y = tree_age)) +
  geom_tile(aes(fill = tree_age, alpha = 0.7)) + 
  scale_fill_gradient(low = "blue", high = "red") +
  labs(x = "Neighborhood", y = "Tree Age") +
  ggtitle("Heatmap with Alpha Transparency: Relationship between Neighborhood and Tree Age") +
