...
*1. What is the relationship between the age of the tree and the tree diameter?* (This question use to be "What is the relationship between density of trees in a neighbourhood and the age of the trees planted?", however, upon further consideration, I did not believe there would be tangible correlation between density of tree clusters and age. Instead I wish to explore growth trends of trees based on species by first determining average diameter based on age.)
